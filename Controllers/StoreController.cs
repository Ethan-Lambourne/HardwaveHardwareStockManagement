...
namespace HardwaveStockManagement.Controllers
{
    public class StoreController : Controller
    {
        ...
        public StoreController(IItemsRepository<Case> caseRepository, IItemsRepository<CPU> cpuRepository,
        ...
        [Route("/Store")]
        public IActionResult StoreView(List<Items>? searchOutput) 
        {
            StoreViewModel storeViewModel = new(_caseRepository.GetAllItems(), _cpuRepository.GetAllItems(), 
                _graphicsCardRepository.GetAllItems(), _laptopRepository.GetAllItems(), _memoryRepository.GetAllItems(), 
                _monitorRepository.GetAllItems(), _motherboardRepository.GetAllItems(), _storageRepository.GetAllItems(),
                null, searchOutput);
        ...
        public IActionResult SearchItems(string SearchInput)
        {
            ...
            else
            {
                ...
                _graphicsCardRepository.GetAllItems(), _laptopRepository.GetAllItems(), _memoryRepository.GetAllItems(),
                _monitorRepository.GetAllItems(), _motherboardRepository.GetAllItems(), _storageRepository.GetAllItems(),
                null, resultsList.Distinct().ToList());
